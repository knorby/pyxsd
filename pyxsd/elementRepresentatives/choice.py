...
class Choice(ElementRepresentative):
    ...
    def __init__(self, xsdElement, parent):
        ...
        complexType.  Makes a blank list for element children.  Uses
        the ER '__init__`.
    ...
    def getMinOccurs(self):
        """retrieves the minOccurs value for elements in the choice.  Sets it
        to the default of 1 if it is not specified.
    ...
    def getMaxOccurs(self):
        """retrieves the maxOccurs value for elements in the choice.  Sets it
        to the default of 1 if it is not specified.  Sets 'unbounded'
        values to 99999, since it needs to be an integer.

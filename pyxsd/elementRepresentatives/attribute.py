...
class Attribute(ElementRepresentative):
    """The class for the attribute tag. Subclass of
    *ElementRepresentative*.  The element tag and the attribute tag
    ...
    def __str__(self):
        ...
        an attribute, without needing a bulky name that does not match
        the name used.
    ...
    def processChildren(self):
        ...
        which can be declared as a child of an attribute. If an
    ...
    def __get__(self, obj, mystery=None):
        """Gets an attribute value from the obj's dictionary. Returns it
        value if it has one, returns the default value if it does not.
    ...
    def __set__(self, obj, value):
        """Sets values to attributes. Converts text Boolean values to binary
        values (integers of 0 and 1).

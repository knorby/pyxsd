...
class Vector (tuple):
    ...
    def __add__(self, vector):
        ...
        if not len(vector) == len(self):
            raise TypeError(
                "vectors must have the same number of dimensions to be added")
        listOfNewValues = []
    ...
    def __sub__(self, vector):
        ...
        if not len(vector) == len(self):
            raise TypeError("vectors must have the same number of dimensions "
    ...
    def findDotProduct(self, vector):
        ...
        if not len(vector) == len(self):
            raise TypeError("the dot product is between two vectors in the "
                            "same vector space")
        for a, b in zip(self, vector):
            product += (a * b)
        return product
    ...
    def distance(self, vector):
        if not isinstance(vector, Vector):
            raise TypeError("the distance formula for vectors is between "
                            "two vectors")
        if not len(vector) == len(self):
            raise TypeError("the distance formula for vectors is between two"
